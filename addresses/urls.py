...
from .views import AddressCreateView, AddressListView, AddressUpdateView, AddressDeleteView, default_view, get_address_view

app_name = 'addresses'

urlpatterns = [
    path('', AddressListView.as_view(), name="index"),
    path('get-address/', get_address_view),
