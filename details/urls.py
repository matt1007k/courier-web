...
from .views import DeleteDetailView, not_on_routed_delivery_view, not_on_routed_origin_view, origin_map_view, destiny_map_view, package_delivered_view, received_package_view
