...
from .views import CompleteInfoClientView, PermissionAuthListApiView, activate_user, login_view, logout_view, register_view, CompleteAddressClientView, user_create_client_view, user_create_view
