...
from .views import DriverCreateView, DriverDetailView, DriverListView, DriverUpdateView, DriverDeleteView, VehicleCreateView, VehicleUpdateView, payment_account_create_view, payment_account_update_view
